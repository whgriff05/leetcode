# Note: the original solution uses a recursive mechanism to compute the result
# This solution uses an iterative mechanism
...
def preorder(root):
    ...
    while queue:
        if queue[0].children:
            queue = [queue[0]] + queue[0].children + queue[1:]
